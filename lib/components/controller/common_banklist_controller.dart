...
import '../../features/services/credit_card/credit_card_application_screen.dart';
import '../../features/services/loan/view/loan_application_screen.dart';
  ...
  screenNavigator(whichScreen, index, title){
    switch (whichScreen) {
      case "loan":
        ...
        break;
      case "creditcard":
        Get.toNamed('/ccapplication', arguments: {'title':banks[index].title});
        break;
      case "insurance":
