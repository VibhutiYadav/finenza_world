...
import '../../cibil_score/splash_view.dart';
import '../../services/calc/emi_calc_screen.dart';
import '../../services/credit_card/credit_card_screen.dart';
import '../../services/insurance/insurance_screen.dart';
import '../../services/loan/view/common_loan_screen.dart';
      ...
      children: List.generate(
        control.imageAssets.length,
          ...
          onTap: () {
            ...
            switch (index) {
              case 0:
                Get.toNamed('/loan', arguments: {'title': control.labels[index]});
                break;
              case 1:
                Get.toNamed('/creditcard', arguments: {'title': control.labels[index]});
                 break;
              case 2:
                Get.toNamed('/insurance', arguments: {'title': control.labels[index]});
                break;
              case 3:
                Get.toNamed('/clac', arguments: {'title': control.labels[index]});
                break;
              default:
